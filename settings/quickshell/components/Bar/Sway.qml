            ...
            RowLayout {
                ...
                Row {
                    ...
                    Item {
                        ...
                        Rectangle {
                            anchors.centerIn: parent
                            width: wallMa.containsMouse || root.wallVisible ? 32 : 0; height: width; radius: 8
                            color: root.wallVisible ? Qt.rgba(zyuTheme.accent.r, zyuTheme.accent.g, zyuTheme.accent.b, 0.18) : Qt.rgba(1,1,1,0.07)
                            Behavior on width { NumberAnimation { duration: 180 } }
                            Behavior on color { ColorAnimation { duration: 150 } }
                        }
                        Text {
                            anchors.centerIn: parent; text: "󰸉"; font.pixelSize: 16
                            font.family: "JetBrainsMono Nerd Font"
                            color: root.wallVisible ? zyuTheme.accent : Qt.rgba(zyuTheme.bar_fg.r, zyuTheme.bar_fg.g, zyuTheme.bar_fg.b, wallMa.containsMouse ? 0.8 : 0.4)
                            Behavior on color { ColorAnimation { duration: 150 } }
                        }
